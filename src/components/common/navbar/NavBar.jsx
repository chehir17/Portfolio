...
const navItems = [
  ...
  { id: 3, name: "Resume", url: "work-process" },
...
const menu = navItems.map((item) => (
  <li key={item.id} onMouseDown={(e) => e.preventDefault()}>
    <Link
      ...
      className={`hover:text-picto-primary px-5 py-3 mx-1 font-semibold`}
    >
      {item.name}
    </Link>
  </li>
          ...
          <p className="">
            ...
            >
              ...
              <span className="ms-1 xs:ms-3">
                <FontAwesomeIcon icon={faEnvelopeCircleCheck} size="l" className="" />
              </span>
            </Link>
          </p>
        </div>
