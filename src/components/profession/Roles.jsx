...
const Roles = ({ role }) => {
  ...
  return (
    <div
      ...
      className="p-4 xs:p-8 bg-white hover:border-r-5 hover:border-picto-primary hover:shadow-xl h-auto shadow-gray-300 ease-out duration-800 rounded-lg my-6 flex relative overflow-hidden"
    >
      <p
